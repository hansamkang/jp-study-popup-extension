...
일본어를 공부하면서 웹페이지의 모르는 단어나 문장을 빠르게 확인하기 위한 Chrome 확장 프로그램입니다.

이 확장 프로그램은 웹페이지 전체를 번역하는 도구가 아닙니다. 사용자가 직접 드래그한 일본어 부분만 한국어로 번역해서 마우스 근처에 작은 팝업으로 보여주는 학습 보조 도구입니다.

## 주요 기능

* 사용자가 드래그한 일본어 텍스트 감지
* 선택한 부분만 한국어 번역 팝업으로 표시
* 웹페이지 전체 번역 없이 읽기 흐름 유지
* 네이버 일본어 사전 링크 제공
* 선택한 단어나 문장 복사
* 팝업 하단 광고 영역 표시
